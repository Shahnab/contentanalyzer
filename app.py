...
headers = {
    "authorization": "6d419b03749f49adbaa28807281da138",
...
st.title("Content Analyzer Engine")

st.sidebar.image("logo.png", width=150)
st.sidebar.header("Video Platform- YouTube")
# st.sidebar.image("https://www.iconpacks.net/icons/2/free-youtube-logo-icon-2431-thumb.png", width=50)
st.sidebar.caption("Kindly ensure the links are in the format: https://www.youtube.com/watch?v=--- ")

st.sidebar.subheader("This Analyser engine allows to")
st.sidebar.caption("- Summarization of video inputs") 
st.sidebar.caption("- Topics discussed in the video,") 
